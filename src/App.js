...
const App = () => {
    ...
    const menu = [
        ...
        },
        {
            ...
            items: [
                { label: "Quản lý chủ đề", icon: "pi pi-fw pi-bookmark",  items: [
                    {label: "Thống kê bài viết", icon: "pi pi-fw pi-bookmark", to: "/thong-ke-bai-viet"},
                    {label: "Quản lý bài viết", icon: "pi pi-fw pi-bookmark", to: "/quan-ly-bai-viet"}

                ] },
                {label: "Quản lý dữ liệu", icon: "pi pi-fw pi-bookmark", to: "/quan-ly-du-lieu"},
                {label: "Quản lý chiến dịch facebook", icon: "pi pi-fw pi-bookmark", to: "/quan-ly-chien-dich-facebook"},
